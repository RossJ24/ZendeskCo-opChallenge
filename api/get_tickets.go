...
func GetTickets(offset int32, silent bool) (*map[string]interface{}, error) {
...
func GetAccountTicketCount() (int32, error) {
	// Create request struct
	...
	return int32(payload["count"].(map[string]interface{})["value"].(float64)), nil
}
